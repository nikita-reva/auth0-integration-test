...
import SectionFandom from './SectionFandom';
...
export class ListingPageComponent extends Component {
  ...
  render() {
    ...
    const fandomOptions = findOptionsForSelectFilter('fandom', customConfig.filters);
          ...
          <LayoutWrapperMain>
            <div className={css.contentWrapperForProductLayout}>
              <div className={css.mainColumnForProductLayout}>
                ...
                <SectionFandom publicData={publicData} options={fandomOptions} />
