...
export const filters = [
  {
    ...
    config: {
      ...
      options: [
        { key: 'swifties', label: 'Swifties' },
        { key: 'hooligans', label: 'Hooligans' },
        { key: 'army', label: 'ARMY' },
      ],
    },
  },
  {
    ...
    config: {
      ...
      options: [
        ...
        { key: 'art_and_collectibles', label: 'Art & Collectibles' },
        { key: 'bags', label: 'Bags' },
        { key: 'clothing', label: 'Clothing' },
        { key: 'events_and_tickets', label: 'Events & Tickets' },
        { key: 'books_films_and_music', label: 'Books, Films & Music' },
        { key: 'home_and_living', label: 'Home & Linving' },
        { key: 'for_pets', label: 'For Pets' },
